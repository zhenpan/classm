...
struct background
{
  ...
  double Omega0_drf; /**< \f$ \Omega_{0 dr} \f: dark radiation fluid*/
  ...
  int index_bg_rho_drf;        /**< dark radiation fluid density */
  int index_bg_Gamma_dmdrf;    /**< dm-drf coupling strength */
  ...
  short has_drf;       /**< presence of dark radiation fluid? */
