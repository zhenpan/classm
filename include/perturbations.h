...
struct perturbs
{
 ...
 int size_tensor_perturbation_data[_MAX_NUMBER_OF_K_FILES_]; /**< Array of sizes of tensor double pointers  */
  ...
  short has_source_delta_drf; /**< do we need source for delta of dark radition fluid? */
  ...
  short has_source_theta_drf; /**< do we need source for theta of dark radiation fluid? */
  ...
  int index_tp_delta_drf; /**< index value for delta of dark radiation fluid */
  ...
  int index_tp_theta_drf;   /**< index value for theta of dark radiation fluid */
...
struct perturb_vector
{
  ...
  int index_pt_delta_drf; /**< drf density */
  int index_pt_theta_drf; /**< drf velocity */
